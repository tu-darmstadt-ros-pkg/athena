#ifndef ESP32_ESTOP_ROS_INTERFACE_RECEIVER_INTERFACE_NODE_HPP
#define ESP32_ESTOP_ROS_INTERFACE_RECEIVER_INTERFACE_NODE_HPP

#include <memory>
#include <string>
#include <vector>

#include <esp32_estop_interface/msg/comm_status.hpp>
#include <esp32_estop_interface/srv/set_enabled.hpp>
...
private:
  ...
  void onSetEnabled( const esp32_estop_interface::srv::SetEnabled::Request::SharedPtr request,
                     esp32_estop_interface::srv::SetEnabled::Response::SharedPtr response );
...
private:
  ...
  Publisher<esp32_estop_interface::msg::CommStatus>::SharedPtr remote_comm_status_publisher_;
  Publisher<esp32_estop_interface::msg::CommStatus>::SharedPtr deadman_comm_status_publisher_;
  rclcpp::Service<esp32_estop_interface::srv::SetEnabled>::SharedPtr set_enabled_service_;
...
#endif // ESP32_ESTOP_ROS_INTERFACE_RECEIVER_INTERFACE_NODE_HPP
